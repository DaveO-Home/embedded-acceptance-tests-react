...
#gpgkey=https://packages.microsoft.com/keys/microsoft.asc' > /etc/yum.repos.d/vscode.repo
    ...
    # Change to correspond with desired repo - defaults to react
    RUN cd ~/embedded-acceptance-tests-react; npm install
    RUN cd ~/embedded-acceptance-tests-react/public; npm install
    WORKDIR /home/tester/embedded-acceptance-tests-react
