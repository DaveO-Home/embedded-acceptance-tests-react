...
import PdfC, { getPdfComp } from "../appl/components/PdfC"
import ToolsC, { getToolsComp } from "../appl/components/ToolsC"
...
function karmaDisplay() {
    ...
    $('body').load("/base/brunch/appl/app_bootstrap.html", function (data) {
        ReactDOM.render(
            <Menulinks />,
