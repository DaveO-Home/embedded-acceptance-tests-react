 ...
 dodexContent = {
	cards: {
		...
		"card16": {
			tab: "P",
			front: {
				content: "<h1>Test Pdf</h1><a ng-reflect-router-link=\"/pdf/test\" href=\"#pdf/test\"><i class=\"fa fa-fw fa-file-pdf\"></i>PDF View</a>"
			},
			back: {
		...
		"card23": {
			tab: "W",
			front: {
				content: "<h1>Angular Welcome</h1><a ng-reflect-router-link=\"/welcome\" href=\"#/welcome\"><i class=\"fa fa-fw fa-file-pdf\"></i>Welcome</a>"
			},
			back: {
				content: ""
			}
